...
public class WebCrawler {
    ...
    */
    public static void main(String[] args) {
        ...
        CrawlingMarkupHandler handler = new CrawlingMarkupHandler(remaining.peek());

        //ArrayList<URL> notFound = new ArrayList<>();
        ...
        try {
            while (!remaining.isEmpty()) {
                ...
                {
                    //notFound.add(handler.getCurrentURL());

                    //remove files from the index that do not exist
                    handler.remove(handler.getCurrentURL());
                }
            ...
            //System.out.println(((WebIndex)handler.getIndex()).map().keySet());
            /*for(URL url:notFound)
            {
                ((WebIndex) handler.getIndex()).map().remove(url);
            }
            System.err.println(notFound);*/
            //System.out.println(CrawlingMarkupHandler.totalTime);
